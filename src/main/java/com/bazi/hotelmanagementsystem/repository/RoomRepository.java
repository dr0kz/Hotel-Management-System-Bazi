...
public interface RoomRepository extends JpaRepository<Room, Long> {
    @Query(value = "Select res.date_from,res.date_to from hotel_management_system.reservation res join hotel_management_system.room r on r.id_room = res.id_room" +
